...
/**
 * <p>
 * This class defines a method, {@link MD5Crypt#crypt(java.lang.String, java.lang.String) crypt()}, which takes a
 ...
 * </p>
 * <p>
 * Release: $Name: xinnetOLFRONT-1-0-311 $
 * </p>
 * <p>
 * Version: $Revision: 1.1 $
 * </p>
 * <p>
 * Last Mod Date: $Date: 2012/01/09 07:06:04 $
 * </p>
 * <p>
...
public final class MD5Crypt {
	...
	public static void main(String[] args) {
		try {
			String pwd = "I7V4QAR9";
			String result4 = MD5Crypt.crypt(pwd, "$1$26$");
	 ...
	 *            permitted to pass a pre-existing MD5Crypt'ed password entry as the salt. crypt() will strip the salt
	 *            chars out properly.
	 * @return An OpenBSD/FreeBSD/Linux-compatible md5-hashed password field.
	 */
	 ...
	 *            explicitly permitted to pass a pre-existing MD5Crypt'ed password entry as the salt. crypt() will strip
	 *            the salt chars out properly.
	 * @return An Apache-compatible md5-hashed password string.
	 */
	 ...
	 * </p>
	 * @param password Plaintext password
	 * @param salt A short string to use to randomize md5. May start with the magic string, which will be ignored. It is
	 *            explicitly permitted to pass a pre-existing MD5Crypt'ed password entry as the salt. crypt() will strip
	 *            the salt chars out properly.
