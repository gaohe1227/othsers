...
<form id="uploadForm" action="<%=basePath %>common/o_upload_image.do" method="post" enctype="multipart/form-data" target="hiddenIframe" style="display:none;width:0px;height:0px;">
...
<input id="uploadImgPath1" name="titleImg" style="width: 220px;" type="text" value="${channelDto.titleImg }"> 
<input value="预览" onclick="previewImg(1);" type="button"><br>
<span id="ufc1"><input id="uploadFile1" name="uploadFile"  size="14" style="width: 180px;" type="file"></span> <label>
...
<img id="preImg1" alt="预览" src="${ctx }${channelDto.titleImg }" style="width: 100px; height: 70px; background-color: rgb(204, 204, 204); border: 1px solid rgb(51, 51, 51);">
</td></tr>
