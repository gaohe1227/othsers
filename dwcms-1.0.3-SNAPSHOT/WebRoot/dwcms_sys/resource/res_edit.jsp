...
<body><div style="position: absolute; z-index: 19700; top: -1970px; left: -1970px; display: none;"><iframe style="width: 186px; height: 199px;" src="templet_file_save_update_files/My97DatePicker.html" border="0" frameborder="0" scrolling="no"></iframe></div>
<div class="body-box">
<div class="rhead">
	<div class="rpos">当前位置: 模板管理 - 添加:${root }</div>
	<form class="ropt">
...
<tbody><tr>
<td class="pn-flabel pn-flabel-h" width="15%"><span class="pn-frequired">*</span>文件名:</td><td class="pn-fcontent" width="85%"><input value="${file.filename }" maxlength="100" name="filename" class="required" size="30" type="text"> <span class="pn-fhelp"></span></td></tr><tr><td colspan="2" class="pn-fbutton">
<textarea wrap="off" name="source" style="width: 90%; height: 350px;" maxlength="1232896">${txt }</textarea>
</td></tr>
