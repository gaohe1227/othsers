package net.zz.utils.base.service.impl;
...
public class BaseServiceImpl<T> implements BaseServiceI<T> {
	...
	public T getByFilter(HqlFilter hqlFilter) {
		...
		return getByHql(hql + hqlFilter.getWhereAndOrderHql(), hqlFilter
				.getParams());
	}
	...
	public List<T> findByFilter(HqlFilter hqlFilter) {
		...
		// String hql = "select distinct t from " + className + " t";
		String hql = "select t from " + className + " t";
		return find(hql + hqlFilter.getWhereAndOrderHql(), hqlFilter
				.getParams());
	}
	...
	public Long countByFilter(HqlFilter hqlFilter) {
		...
		String hql = "select count(t) from " + className + " t";
	...
	@Override
	public void deleteBatch(List<T> pos) {
		for (T o : pos) {
			baseDao.delete(o);
		}
	}
	...
	@Override
	public List<T> find(String hql, String[] params, Object[] values) {
		return baseDao.find(hql, params, values);
	}

	@Override
	public List<T> find(String hql, String param, Object value) {
		return baseDao.find(hql, new String[]{param}, new Object[]{value});
	}
